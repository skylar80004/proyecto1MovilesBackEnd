...
ActiveRecord::Schema.define(version: 2019_04_24_035734) do
  ...
  create_table "photo_restaurants", force: :cascade do |t|
    t.string "image_url"
    t.bigint "restaurant_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["restaurant_id"], name: "index_photo_restaurants_on_restaurant_id"
  end
  ...
  add_foreign_key "photo_restaurants", "restaurants"
